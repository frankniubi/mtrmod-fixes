...
public final class DestinationSignAtlasLayoutTest {
	...
	public void validatesFlexibleFootprintsAndOnePageCapacity() {
		...
		Assertions.assertThrows(IllegalArgumentException.class, () -> DestinationSignAtlasLayout.create(small, DestinationSignStyle.ARRIVAL_ORDER, 1, 2, true));
		Assertions.assertThrows(IllegalArgumentException.class, () -> DestinationSignAtlasLayout.create(small, DestinationSignStyle.DESTINATION_FLAG, 2, 2, true));
